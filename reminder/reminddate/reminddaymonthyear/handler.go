...
// nolint:lll
const HandlePattern = `\/remind (?P<who>me|chat) on the (?P<day>\d{1,2})(?:(st|nd|rd|th))? of (?P<month>january|february|march|april|may|june|july|august|september|october|november|december) (?P<year>\d{4}) (?P<message>.*)`
